...
const backboneProxyConfig = appConfig.getBackboneProxyConfig();
...
const API_SERVICE_MAP = JSON.parse(process.env.BACKBONE_API_SERVICE_MAP);
const OAUTH_AUTHENTICATION_TYPE = process.env.BACKBONE_AUTH_AUTHENTICATION_TYPE;
const OAUTH_CLIENT_ID = process.env.BACKBONE_AUTH_CLIENT_ID;
const OAUTH_CLIENT_SECRET = process.env.BACKBONE_AUTH_CLIENT_SECRET;
const OAUTH_GRANT_TYPE = process.env.BACKBONE_AUTH_GRANT_TYPE;
const OAUTH_TOKEN_URL = process.env.BACKBONE_AUTH_SERVER_URI;
const OAUTH_USER_ALIAS = process.env.BACKBONE_AUTH_USER_ALIAS;
const OAUTH_USER_PASSWORD = process.env.BACKBONE_AUTH_USER_PASSWORD;
...
let getApiEndpoint = function (path) {
    ...
    for (const element of backboneProxyConfig) {
